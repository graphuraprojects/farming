      ...
      <div className="relative h-[350px] sm:h-[400px] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center justify-center px-4">
          <div className="text-center max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[4px] mb-4" style={{ color: color.gold }}>
              Our Story
            </p>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4 text-white tracking-tight">
              About{" "}
              <span style={{ color: color.lush }}>AgriRent</span>
            </h1>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-20" style={{ background: `linear-gradient(to top, ${color.bg}, transparent)` }} />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 -mt-16 relative z-20">
          ...
          {stats.map((stat, index) => {
            ...
            return (
              <div
                ...
                style={{ boxShadow: shadow.md, border: `1px solid ${color.border}` }}
              >
                <div
                ...
                <h3 className="text-2xl font-bold mb-1" style={{ color: color.text }}>
                  <CountUp
                    end={stat.value}
                    duration={2.5}
                    delay={0.8}
        ...
        <div className="mb-16">
          ...
          >
            <div className="text-center mb-6">
              <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight mb-4" style={{ color: color.text }}>
                The Story Behind AgriRent
              </h2>
            </div>
            <div className="text-sm leading-[1.8] space-y-4" style={{ color: color.textSoft }}>
              <p>
              ...
              <p>
                Founded by <span className="font-semibold" style={{ color: color.emerald }}>Graphura India Private Limited</span>, our platform digitizes the agricultural machinery rental ecosystem, making it easier for machine owners to monetize their idle equipment and for farmers to access the tools they need, exactly when they need them.
              </p>
              <p>
        ...
        <div className="mb-16">
          <div className="text-center mb-10">
            <p className="text-xs font-semibold uppercase tracking-[3px] mb-2" style={{ color: color.emerald }}>
              What We Do
            </p>
            <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight mb-3" style={{ color: color.text }}>
              Our Mission
            </h2>
            <p className="text-sm max-w-2xl mx-auto" style={{ color: color.textSoft }}>
            ...
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-sm font-bold mb-2" style={{ color: color.text }}>
                    {feature.title}
                  </h3>
        ...
        <div className="mb-16">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight" style={{ color: color.text }}>
              Our Values
            </h2>
          </div>
          ...
          <div className="relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                style={{ background: gradientBg(color.lush, color.emeraldMid), boxShadow: `0 4px 16px ${color.lush}40` }}
              >
                Browse Machines
