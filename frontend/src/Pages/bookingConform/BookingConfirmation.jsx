...
const BookingConfirmation = () => {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center font-bold text-[#03a74f]">Processing Order...</div>;
      ...
      <div className="min-h-screen w-full bg-[#fafaf7] text-[#2b2b2b] font-['Inter',sans-serif] pb-20">
        <div className="max-w-[800px] mx-auto pt-10 px-4 space-y-10">
          ...
          <div className="space-y-8">
            <h2 className="text-xl font-semibold border-b border-[#03a74f]/10 pb-2">Machine Details</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {orderData.nextSteps.map((step, idx) => (
                <div key={idx} className="bg-white p-5 rounded-xl border border-[#03a74f]/10 shadow-sm">
      ...
      resolve({
        ...
        machines: [
          ...
          },
          {
            ...
            end_date: "Oct 18",
            usage_hours: 144,
            image_url: "https://media.istockphoto.com/id/1978669262/photo/excavator-on-the-construction-site.webp?a=1&b=1&s=612x612&w=0&k=20&c=2NuqqvCw2dLKz5nyEJrIaLJmdEpru27XyfX5Apad6RY="
          }
        ],
        next_steps: [
          { title: "Contact Owner", desc: "Check inbox for details." },
